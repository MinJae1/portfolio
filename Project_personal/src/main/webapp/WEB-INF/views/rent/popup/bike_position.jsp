...
<body>
	<input id="latitude" type="hidden" value="${position.latitude}">
	<input id="longitude" type="hidden" value="${position.longitude}">
	...
	<script>
		...
		var imageSrc = '/resources/image/marker.png', // 마커이미지의 주소입니다    
